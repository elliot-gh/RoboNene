...
class DiscordClient {
  ...
  loadDb(dir = CLIENT_CONSTANTS.DB_DIR) {
     ...
     * @property {string} sekai_id - The Sekai ID of the user
     * @property {number} private - Whether the user has opted out of public tracking
     * @property {number} quiz_correct - The number of correct answers the user has given
     * @property {number} quiz_question - The number of questions the user has answered
     */
    ...
    /**
     * @typedef {Object} ChannelTracking
     * @property {string} channel_id - The Discord ID of the channel
     * @property {string} guild_id - The Discord ID of the guild
     * @property {number} tracking_type - The type of tracking the channel is doing
     */
  ...
  loadCutoffDb(dir = CLIENT_CONSTANTS.CUTOFF_DB_DIR) {
    ...
    /**
     * @typedef {Object} TierCutoff
     * @property {number} EventID - The ID of the event
     * @property {number} Tier - The tier of the event
     * @property {number} Timestamp - The timestamp of the cutoff
     * @property {number} Score - The score of the cutoff
  ...
  loadPrayerDb(dir = CLIENT_CONSTANTS.PRAYER_DB_DIR) {
     ...
     * @property {number} id - The unique ID of the user
     * @property {number} luck - The luck of the user
     * @property {number} prays - The number of prayers the user has done
     * @property {number} lastTimestamp - The timestamp of the last prayer
     * @property {number} totalLuck - The total luck of the user
     */
